...
def sobol_design(
    ...
    use_points = 1 << (n_samples - 1).bit_length()  # shift_bit_length(num_points)
...
def main_a():
    print("Running Box-Behnken design example.")
    ...
    scaled_design = box_behnken_design(n_factors, low, high)
